...
class TransactionCategoryController extends Controller
{
    ...
    public function store(TransactionCategoryRequest $request)
    {
        try {
            ...
            activityLog("Created Transaction Category {$transactionCategory->name}", $transactionCategory);
    ...
    public function update(TransactionCategoryRequest $request, TransactionCategory $transactionCategory)
    {
        try {
            ...
            activityLog("Updated Transaction Category {$transactionCategory->name}", $transactionCategory);
            return response()->json();
        } catch (\Exception $e) {
            throw new \Exception($e->getMessage());
        }
    ...
    public function destroy(Request $request)
    {
        try {
            ...
            foreach ($ids as $id) {
                ...
                activityLog("Deleted Transaction Category {$transactionCategory->name}", $transactionCategory);
