    ...
    class SubAccountController extends Controller
    {
        ...
        public function store(SubAccountRequest $request)
        {
            try {
                ...
                activityLog( "Created Sub Account {$subAccount->name}" , $subAccount );
        ...
        public function update(SubAccountRequest $request , SubAccount $subAccount)
        {
            try {
                ...
                activityLog( "Updated Sub Account {$subAccount->name}" , $subAccount );
        ...
        public function destroy(Request $request)
        {
            try {
                ...
                foreach ( $ids as $id ) {
                    ...
                    activityLog( "Deleted Sub Account {$subAccount->name}" , $subAccount );
                    $subAccount->delete();
                }
                return response()->json();
            } catch ( \Exception $e ) {
