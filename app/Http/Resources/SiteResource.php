    ...
    class SiteResource extends JsonResource
    {
        ...
        public function toArray($request) : array
        {
            return [
                ...
                'site_default_timezone'          => $this->info[ 'site_default_timezone' ] ?? 'UTC' ,
                'site_default_currency'          => $this->info[ 'site_default_currency' ] ?? 'USD' ,
                ...
                'site_email_verification'                    => $this->info[ 'site_email_verification' ] ?? Ask::NO ,
                'site_phone_verification'                    => $this->info[ 'site_phone_verification' ] ?? Ask::NO ,
                'site_default_language'                      => $this->info[ 'site_default_language' ] ?? 'en' ,
                ...
                'site_online_payment_gateway'                => $this->info[ 'site_online_payment_gateway' ] ?? Ask::NO ,
