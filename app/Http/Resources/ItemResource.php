    ...
    class ItemResource extends JsonResource
    {
        ...
        public function toArray($request) : array
        {
            ...
            return [
                "id"                    => $this->id ,
                "name"                  => $this->name ,
                "stock_quantity"        => $this->is_stockable == Ask::YES ? $this->stockQuantity($this->id) : null ,
                "slug"                  => $this->slug ,
        ...
        private function stockQuantity($id)
        {
            $stock = Stock::where([ 'model_type' => Item::class , 'product_id' => $id ])->first();
