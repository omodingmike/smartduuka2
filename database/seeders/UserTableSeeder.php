...
class UserTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($envService->getValue('DEMO')) {
            ...
            $customerOne->assignRole(Role::find(EnumRole::CUSTOMER));
            Address::create([
            ...
            $employeeOne->assignRole(Role::find(EnumRole::MANAGER));
            Address::create([
            ...
            $employeeTwo->assignRole(Role::find(EnumRole::MANAGER));
            Address::create([
            ...
            $posOperatorOne->assignRole(Role::find(EnumRole::POS_OPERATOR));
            Address::create([
            ...
            $posOperatorTwo->assignRole(Role::find(EnumRole::POS_OPERATOR));
            Address::create([
            ...
            $stuffOne->assignRole(Role::find(EnumRole::STUFF));
            Address::create([
            ...
            $stuffTwo->assignRole(Role::find(EnumRole::STUFF));
            Address::create([
