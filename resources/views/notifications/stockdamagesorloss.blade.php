...
<body style="margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="display: none; max-height: 0px; overflow: hidden;">Notification: A manual stock adjustment was logged at your business.</div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="wrapper" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0px 4px 10px rgba(0,0,0,0.1); border-top: 5px solid #EA580C;">
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 20px 10px 20px;">
                            <img src="https://img.icons8.com/ios-filled/100/EA580C/edit-property.png" width="64" height="64" alt="Adjustment" style="display: block; margin-bottom: 15px;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #EA580C;">Stock Adjustment Alert</h1>
                        </td>
                    </tr>
                    <tr>
                        <td class="mobile-padding" style="padding: 20px 50px 30px 50px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #555555;">Hi <strong>{{username}}</strong>, a manual stock adjustment was just logged at <strong>{{business_name}}</strong> for <strong>{{product_name}}</strong>.</p>
                            <div style="background-color: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 6px; padding: 20px; margin-bottom: 25px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Qty Adjusted:</td>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #EA580C; font-weight: bold; text-align: right;">{{qty_adjusted}}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Reason:</td>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #333; text-align: right;">{{reason}}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Logged by:</td>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #333; text-align: right;">{{staff_name}}</td>
                                    </tr>
                                </table>
                            </div>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 50px;" bgcolor="#EA580C">
                                                    <a href="{{adjustment_link}}" target="_blank" class="button" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 50px; border: 1px solid #EA580C; display: inline-block; font-weight: bold; box-shadow: 0 4px 6px rgba(234, 88, 12, 0.3);">View Activity Log</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
