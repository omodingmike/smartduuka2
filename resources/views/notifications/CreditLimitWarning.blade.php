...
<body style="margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="display: none; max-height: 0px; overflow: hidden;">Warning: A customer is attempting to exceed their credit limit.</div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="wrapper" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0px 4px 10px rgba(0,0,0,0.1); border-top: 5px solid #EA580C;">
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 20px 10px 20px;">
                            <img src="https://img.icons8.com/ios-filled/100/EA580C/high-importance.png" width="64" height="64" alt="Warning" style="display: block; margin-bottom: 15px;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #EA580C;">Credit Limit Warning</h1>
                        </td>
                    </tr>
                    <tr>
                        <td class="mobile-padding" style="padding: 20px 50px 30px 50px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #555555;">Hi <strong>{{username}}</strong>, <strong>{{customer_name}}</strong> is attempting to make a credit purchase of UGX {{attempted_amount}}, which exceeds their approved credit limit.</p>
                            <div style="background-color: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 6px; padding: 20px; margin-bottom: 25px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Attempted Purchase:</td>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #333; font-weight: bold; text-align: right;">UGX {{attempted_amount}} [cite: 30]</td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Current Debt:</td>
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #333; text-align: right;">UGX {{current_debt}} [cite: 29]</td>
                                    </tr>
                                    <tr>
                                        <td style="padding-top: 10px; border-top: 1px dashed #ccc; font-size: 16px; color: #EA580C; font-weight: bold;">Credit Limit:</td>
                                        <td style="padding-top: 10px; border-top: 1px dashed #ccc; font-size: 16px; color: #EA580C; font-weight: bold; text-align: right;">UGX {{credit_limit}}</td>
                                    </tr>
                                </table>
                            </div>
                            <p style="margin: 0 0 25px 0; font-size: 16px; line-height: 24px; color: #555555; text-align: center;">Action is required at the POS to approve or deny this transaction.</p>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 50px;" bgcolor="#EA580C">
                                                    <a href="{{pos_link}}" target="_blank" class="button" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 50px; border: 1px solid #EA580C; display: inline-block; font-weight: bold; box-shadow: 0 4px 6px rgba(234, 88, 12, 0.3);">Review Customer Account</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
