...
<head>
    ...
    <title>Your Receipt from Smart Duuka</title>
    <style>
...
<body style="margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="display: none; max-height: 0px; overflow: hidden;">Thank you for your purchase! Here is your digital receipt.</div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="wrapper" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0px 4px 10px rgba(0,0,0,0.1); border-top: 5px solid #EA580C;">
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 20px 10px 20px;">
                            <img src="https://img.icons8.com/ios-filled/100/EA580C/receipt.png" width="64" height="64" alt="Receipt" style="display: block; margin-bottom: 15px;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #EA580C;">Thank You For Shopping!</h1>
                        </td>
                    </tr>
                    <tr>
                        <td class="mobile-padding" style="padding: 20px 50px 30px 50px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #555555;">Hi <strong>{{customer_name}}</strong>, we appreciate your business. Here are the details of your recent transaction.</p>
                            <div style="background-color: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 6px; padding: 20px; margin-bottom: 25px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="padding-bottom: 10px; font-size: 14px; color: #333; font-weight: bold; text-align: right;">{{receipt_no}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr><td colspan="2" style="border-top: 1px solid #ccc; padding-top: 10px; padding-bottom: 10px; font-weight: bold; font-size: 14px;">Items</td></tr>
                                    <tr>
                                        <td style="padding-bottom: 5px; font-size: 14px; color: #555;">{{item_qty}}x {{item_name}}</td>
                                        <td style="padding-bottom: 5px; font-size: 14px; color: #555; text-align: right;">UGX {{item_price}}</td>
                                    </tr>
                                    <tr><td colspan="2" style="border-top: 1px dashed #ccc; padding-top: 10px;"></td></tr>
                                    <tr>
                                        <td style="font-size: 16px; color: #EA580C; font-weight: bold;">Total Paid:</td>
                                        <td style="font-size: 16px; color: #EA580C; font-weight: bold; text-align: right;">UGX {{total_amount}}</td>
                                    </tr>
                                </table>
                            </div>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 50px;" bgcolor="#EA580C">
                                                    <a href="{{receipt_link}}" target="_blank" class="button" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 50px; border: 1px solid #EA580C; display: inline-block; font-weight: bold; box-shadow: 0 4px 6px rgba(234, 88, 12, 0.3);">Download PDF Receipt</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
