...
<body style="margin: 0; padding: 0; background-color: #f4f4f4;">
    ...
    <div style="display: none; max-height: 0px; overflow: hidden;">
        It's been a while! Come back to Smart Duuka today and enjoy a special discount on your next renewal.
    </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="wrapper"
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 20px 10px 20px;">
                            <img src="https://img.icons8.com/ios-filled/100/ff6600/gift--v1.png" width="64"
                                height="64" alt="Gift" style="display: block; margin-bottom: 15px;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #ff6600;">We Miss You!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 20px 50px 30px 50px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #555555;">
                                Hi <strong>{{$username}}</strong>, it’s been a while since you last used Smart Duuka to manage <strong>{{$business_name}}</strong>.
                            </p>

                            <p style="margin: 0 0 25px 0; font-size: 16px; line-height: 24px; color: #555555;">
                                We know running a business is tough, and keeping track of sales shouldn't add to the stress. We’d love to have you back, so we’re offering you a special discount to restart your subscription.
                            </p>

                            <div
                                style="background-color: #fff4e6; border: 2px dashed #ff6600; border-radius: 6px; padding: 25px; text-align: center; margin-bottom: 25px;">
                                <p
                                    style="margin: 0 0 10px 0; font-size: 14px; color: #ff6600; font-weight: bold; text-transform: uppercase;">
                                    Use Promo Code:</p>
                                <p
                                    style="margin: 0; font-size: 28px; color: #333333; font-weight: bold; letter-spacing: 2px;">
                                    {{$discount_code}}</p>
                                <p style="margin: 10px 0 0 0; font-size: 14px; color: #666666;">Get
                                    {{$discount_percentage}}% off your next month!</p>
                            </div>
