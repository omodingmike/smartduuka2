...
<head>
    ...
    <title>Subscription Reminder - 7 Days Left</title>
    <style>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td bgcolor="#f4f4f4" align="center" style="padding: 20px 0 40px 0;">
                ...
                <!-- Main Container (Orange Reminder Theme) -->
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="wrapper"
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 20px 10px 20px;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #ff6600;">Subscription
                                Reminder</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 20px 50px 30px 50px;">
                            <h2 style="margin: 0 0 20px 0; font-size: 20px; color: #333333;">Hi {{$username}},</h2>

                            <!-- Business Details Box -->
                            <div
                                style="background-color: #fff4e6; border-radius: 6px; padding: 15px; margin-bottom: 25px;">
                                <p style="margin: 0 0 5px 0; font-size: 15px; color: #555; font-weight: bold;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #666666;">
                                Just a heads up! Your subscription is set to expire in <strong style="color: #ff6600;">7
                                    days</strong> on <strong>{{$expiry_date}}</strong>.
                            </p>

                            <!-- Payment Instructions -->
                            <div
                                style="background-color: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 6px; padding: 20px; margin-bottom: 30px;">
                                <h3
                                    style="margin: 0 0 15px 0; font-size: 16px; color: #333; text-transform: uppercase; letter-spacing: 0.5px;">
                                    How to Renew
                                </h3>

                                <strong style="color: #ff6600; display: block; margin-bottom: 5px;">Option 1: Via the
                                    System</strong>
                                <ol
                                    style="margin: 0 0 15px 0; padding-left: 20px; color: #666; font-size: 14px; line-height: 22px;">
                                    <li>Log in to your Smart Duuka dashboard.</li>
                                    <li>Select your preferred Package.</li>
                                    <li>Enter your <strong>MTN MoMo</strong> or <strong>Airtel Money</strong> number.
                                    </li>
                                    <li>Approve the PIN prompt on your phone.</li>
                                </ol>

                                <div style="border-top: 1px dashed #cccccc; margin: 15px 0;"></div>

                                <strong style="color: #28a745; display: block; margin-bottom: 5px;">Option 2: Via
                                    WhatsApp</strong>
                                <ul
                                    style="margin: 0; padding-left: 20px; color: #666; font-size: 14px; line-height: 22px;">
                                    <li>Send a message to <a href="https://wa.me/256771915925"
                                            style="color: #28a745; text-decoration: none; font-weight: bold;">+256 771
                                            915 925</a>.</li>
                                    <li>Enter your Business ID: <strong>{{$business_id}}</strong>.</li>
                                    <li>Select plan & enter payment number.</li>
                    ...
                    <!-- FOOTER (Standard Uniform with Icons) -->
                    <tr>
