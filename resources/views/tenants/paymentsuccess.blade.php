...
<head>
    ...
    <title>Payment Successful - Smart Duuka</title>
    <style>
...
<div style="display: none; max-height: 0px; overflow: hidden;">
    Thank you for your payment! Your Smart Duuka subscription has been successfully renewed.
</div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="wrapper"
                ...
                <tr>
                    <td align="center" style="padding: 30px 20px 10px 20px;">
                        <img src="https://img.icons8.com/ios-filled/100/28a745/checked--v1.png" width="64"
                             height="64" alt="Success" style="display: block; margin-bottom: 15px;">
                        <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #28a745;">Payment Successful!</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="mobile-padding" style="padding: 20px 50px 30px 50px;">
                        <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #555555;">
                            Hi <strong>{{$username}}</strong>, thank you for your payment. Your subscription has been successfully renewed. Here is your
                            receipt:
                        </p>

                        <div
                                style="background-color: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 6px; padding: 20px; margin-bottom: 25px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Business:</td>
                                    <td
                                            style="padding-bottom: 10px; font-size: 14px; color: #333; font-weight: bold; text-align: right;">
                                        {{$business_name}}</td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Amount Paid:
                                    </td>
                                    <td
                                            style="padding-bottom: 10px; font-size: 14px; color: #333; font-weight: bold; text-align: right;">
                                        UGX {{$amount_paid}}</td>
                                ...
                                <tr>
                                    <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Transaction ID:
                                    </td>
                                    <td
                                            style="padding-bottom: 10px; font-size: 14px; color: #333; text-align: right;">
                                        {{$txn_id}}</td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 10px; font-size: 14px; color: #666;">Payment Method:
                                    </td>
                                    <td
                                            style="padding-bottom: 10px; font-size: 14px; color: #333; text-align: right;">
                                        {{$payment_method}}</td>
                                ...
                                <tr>
                                    <td colspan="2" style="border-top: 1px dashed #ccc; padding-top: 10px;"></td>
                                </tr>
                                <tr>
                                    <td style="font-size: 15px; color: #28a745; font-weight: bold;">New Expiry Date:
                                    </td>
                                    <td
                                            style="font-size: 15px; color: #28a745; font-weight: bold; text-align: right;">
                                        {{$new_expiry_date}}</td>
                                </tr>
                            </table>
                        </div>
