...
<div style="display: none; max-height: 0px; overflow: hidden;">
    Welcome to Smart Duuka! We are thrilled to have you on board. Let's get your business set up.
</div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="wrapper"
                ...
                <tr>
                    <td align="center" style="padding: 30px 20px 10px 20px;">
                        <img src="https://img.icons8.com/ios-filled/100/ff6600/rocket.png" width="64" height="64"
                             alt="Welcome" style="display: block; margin-bottom: 15px;">
                        <h1 style="margin: 0; font-size: 24px; font-weight: bold; color: #ff6600;">Welcome to Smart Duuka!</h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="mobile-padding" style="padding: 20px 50px 30px 50px;">
                        <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #555555;">
                            Hi <strong>{{$username}}</strong>, welcome to the Smart Duuka family! We are incredibly excited to help you streamline, manage, and
                            grow <strong>{{$business_name}}</strong>.
                        </p>

                        <div
                                style="background-color: #fff4e6; border-left: 4px solid #ff6600; border-radius: 4px; padding: 20px; margin-bottom: 25px;">
                            <h3 style="margin: 0 0 10px 0; font-size: 16px; color: #333333;">Getting Started is Easy</h3>
                            <ul style="margin: 0; padding-left: 20px; color: #555555; font-size: 14px; line-height: 22px;">
                                <li><strong>Add your products:</strong> Start tracking your inventory in real-time.</li>
                                <li><strong>Record sales:</strong> Log your daily transactions quickly and securely.</li>
                                <li><strong>Generate reports:</strong> Gain deep insights into how your business is performing.</li>
                            </ul>
                        </div>

                        <p style="margin: 0 0 25px 0; font-size: 16px; line-height: 24px; color: #555555;">
                            Dive right in and explore all the features designed to make running your business completely stress-free.
                        </p>
